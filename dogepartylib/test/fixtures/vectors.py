...
from dogepartylib.lib.messages.scriptlib import processblock
from dogepartylib.lib.messages.scriptlib.processblock import ContractError
from dogepartylib.lib.api import APIError
from dogepartylib.lib.util import (DebitError, CreditError, QuantityError)
...
UNITTEST_VECTOR = {
    ...
    'blocks': {
        'parse_tx': [{
            'in': ({'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F-nW8dXfYakP7aSyPuzEcAdFyrjFXimPkvct', 'supported': 1, 'block_index': DP['default_block'], 'fee': 10000, 'block_time': 155409000, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'btc_amount': 7800, 'data': b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00', 'tx_index': 502, 'destination': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65'},),
            'out': None
        },  {
            'in': ({'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'supported': 1, 'block_index': DP['default_block'], 'fee': 10000, 'block_time': 155409000, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'btc_amount': 7800, 'data': b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00', 'tx_index': 502, 'destination': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65-nW8dXfYakP7aSyPuzEcAdFyrjFXimPkvct'},),
            'out': None
        }],
        'parse_block': [{
    ...
    'cancel': {
        'compose': [{
            ...
            'out': ('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', [], b'\x00\x00\x00F\xba\x0e\xf1\xdf\xbb\xc8}\xf9N\x1d\x19\x8b\x0e\x9e<\x060\x17\x10\xd4\xaa\xb3\xd8Q\x16\xcb\xc8\x19\x99TdJ')
        },  {
            'in': (ADDR[1], 'foobar'),
    ...
    'burn': {
        ...
        'compose': [{
            ...
            'out': ('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', [('ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH', 62000000)], None)
        }, {
            'in': (ADDR[0], DP['burn_quantity']),
            'error': (exceptions.ComposeError, '1 DOGE may be burned per address')
        }, {
            'in': (MULTISIGADDR[0], int(DP['quantity'] / 2)),
            'out': ('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', [('ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH', 50000000)], None)
        }],
        'parse': [{
            'in': ({'block_index': DP['default_block'], 'destination': 'ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH', 'fee': 10000, 'block_time': 155409000, 'supported': 1, 'btc_amount': 62000000, 'data': b'', 'source': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'tx_index': 502, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8'},),
            'records': [
                {'table': 'burns', 'values': {'tx_index': 502, 'earned': 92995811159, 'burned': 62000000, 'source': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'status': 'valid', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'block_index': DP['default_block']}},
                {'table': 'credits', 'values': {'block_index': DP['default_block'], 'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'asset': 'XDP', 'calling_function': 'burn', 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'quantity': 92995811159}}
            ]
        }, {
            'in': ({'supported': 1, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'btc_amount': 50000000, 'block_index': DP['default_block'], 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'fee': 10000, 'data': b'', 'block_time': 155409000, 'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'tx_index': 502, 'destination': 'ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH'},),
            'records': [
                {'table': 'burns', 'values': {'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'block_index': DP['default_block'], 'burned': 50000000, 'status': 'valid', 'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'earned': 74996621902, 'tx_index': 502}},
                {'table': 'credits', 'values': {'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'block_index': DP['default_block'], 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'asset': 'XDP', 'calling_function': 'burn', 'quantity': 74996621902}}
            ]
        }],
    },
    'destroy': {
        'validate': [{
            'in': (ADDR[0], None, 'XDP', 1),
            'out': None
        },  {
            'in': (ADDR[0], None, 'foobar', 1),
            'error': (exceptions.ValidateError, 'asset invalid')
        },  {
            'in': (ADDR[0], ADDR[1], 'XDP', 1),
            'error': (exceptions.ValidateError, 'destination exists')
        },  {
            'in': (ADDR[0], None, 'DOGE', 1),
            'error': (exceptions.ValidateError, 'cannot destroy DOGE')
        },  {
            'in': (ADDR[0], None, 'XDP', 1.1),
            'error': (exceptions.ValidateError, 'quantity not integer')
        },  {
            'in': (ADDR[0], None, 'XDP', 2**63),
            'error': (exceptions.ValidateError, 'quantity too large')
        },  {
            'in': (ADDR[0], None, 'XDP', -1),
            'error': (exceptions.ValidateError, 'quantity negative')
        },  {
            'in': (ADDR[0], None, 'XDP', 2**62),
            'error': (exceptions.BalanceError, 'balance insufficient')
        }],
        'pack': [{
            'in': ('XDP', 1, bytes(9999999)),
    ...
    'send': {
        'validate': [{
            'in': (ADDR[0], ADDR[1], 'XDP', DP['quantity'], 1),
            'out': ([])
        }, {
            'in': (ADDR[0], ADDR[1], 'DOGE', DP['quantity'], 1),
            'out': (['cannot send bitcoins'])
        }, {
            'in': (ADDR[0], ADDR[1], 'XDP', DP['quantity'] / 3, 1),
            'out': (['quantity must be in satoshis'])
        }, {
            'in': (ADDR[0], ADDR[1], 'XDP', -1 * DP['quantity'], 1),
            'out': (['negative quantity'])
        }, {
            'in': (ADDR[0], MULTISIGADDR[0], 'XDP', DP['quantity'], 1),
            'out': ([])
        }, {
        ...
        'compose': [{
            'in': (ADDR[0], ADDR[1], 'XDP', DP['small']),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', None)], b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x02\xfa\xf0\x80')
        }, {
            'in': (ADDR[0], ADDR[1], 'XDP', DP['quantity'] * 10000000),
            'error': (exceptions.ComposeError, 'insufficient funds')
        }, {
            'in': (ADDR[0], ADDR[1], 'XDP', DP['quantity'] / 3),
            'error': (exceptions.ComposeError, 'quantity must be an int (in satoshi)')
        }, {
            'in': (ADDR[0], MULTISIGADDR[0], 'XDP', DP['quantity']),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', None)], b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00')
        }, {
            'in': (MULTISIGADDR[0], ADDR[0], 'XDP', DP['quantity']),
            'out': ('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', [('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', None)], b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00')
        }, {
            'in': (MULTISIGADDR[0], MULTISIGADDR[1], 'XDP', DP['quantity']),
            'out': ('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', [('1_nUtoWndFgmzPquS2iJAFUPEtVhRX7jfobH_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', None)], b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00')
        }, {
            'in': (ADDR[0], ADDR[1], 'MAXI', 2**63 - 1),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', None)], b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03:>\x7f\xff\xff\xff\xff\xff\xff\xff')
        }, {
            'in': (ADDR[0], ADDR[1], 'MAXI', 2**63 + 1),
            'error': (exceptions.ComposeError, 'insufficient funds')
        }, {
            'in': (ADDR[0], ADDR[1], 'DOGE', DP['quantity']),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 100000000)], None)
        }],
        'parse': [{
            'in': ({'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'supported': 1, 'block_index': DP['default_block'], 'fee': 10000, 'block_time': 155409000, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'btc_amount': 7800, 'data': b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00', 'tx_index': 502, 'destination': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65'},),
            'records': [
                {'table': 'sends', 'values': {'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'block_index': DP['default_block'], 'status': 'valid', 'asset': 'XDP', 'quantity': 100000000, 'tx_index': 502, 'destination': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65'}},
                {'table': 'credits', 'values': {'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'block_index': DP['default_block'], 'calling_function': 'send', 'asset': 'XDP', 'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'quantity': 100000000}},
                {'table': 'debits', 'values': {'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'block_index': DP['default_block'], 'asset': 'XDP', 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'action': 'send', 'quantity': 100000000}}
            ]
        }, {
            ...
            'records': [
                {'table': 'sends', 'values': {'block_index': DP['default_block'], 'quantity': 500, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'tx_index': 502, 'asset': 'NODIVISIBLE', 'status': 'valid', 'destination': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'}},
                {'table': 'credits', 'values': {'block_index': DP['default_block'], 'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'calling_function': 'send', 'quantity': 500, 'asset': 'NODIVISIBLE'}},
                {'table': 'debits', 'values': {'block_index': DP['default_block'], 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'action': 'send', 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'quantity': 500, 'asset': 'NODIVISIBLE'}}
            ]
        }, {
            'in': ({'btc_amount': 7800, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'fee': 10000, 'tx_index': 502, 'destination': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'data': b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00', 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'supported': 1, 'block_time': 155409000, 'block_index': DP['default_block']},),
            'records': [
                {'table': 'sends', 'values': {'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'destination': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'asset': 'XDP', 'quantity': 100000000, 'tx_index': 502, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'status': 'valid', 'block_index': DP['default_block']}},
                {'table': 'credits', 'values': {'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'quantity': 100000000, 'asset': 'XDP', 'block_index': DP['default_block'], 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'calling_function': 'send'}},
                {'table': 'debits', 'values': {'action': 'send', 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'quantity': 100000000, 'asset': 'XDP', 'block_index': DP['default_block'], 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d'}}
            ]
        }, {
            'in': ({'data': b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00', 'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'supported': 1, 'block_time': 155409000, 'fee': 10000, 'tx_index': 502, 'btc_amount': 7800, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'block_index': DP['default_block'], 'destination': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'},),
            'records': [
                {'table': 'sends', 'values': {'quantity': 100000000, 'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'status': 'valid', 'destination': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'asset': 'XDP', 'tx_index': 502, 'block_index': DP['default_block']}},
                {'table': 'credits', 'values': {'quantity': 100000000, 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'calling_function': 'send', 'asset': 'XDP', 'block_index': DP['default_block'], 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'}},
                {'table': 'debits', 'values': {'quantity': 100000000, 'action': 'send', 'asset': 'XDP', 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'block_index': DP['default_block'], 'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2'}}
            ]
        }, {
            'in': ({'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'destination': '1_nUtoWndFgmzPquS2iJAFUPEtVhRX7jfobH_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'supported': 1, 'block_time': 155409000, 'fee': 10000, 'block_index': DP['default_block'], 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'btc_amount': 7800, 'data': b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00', 'tx_index': 502, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8'},),
            'records': [
                {'table': 'sends', 'values': {'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'destination': '1_nUtoWndFgmzPquS2iJAFUPEtVhRX7jfobH_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'asset': 'XDP', 'status': 'valid', 'block_index': DP['default_block'], 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'quantity': 100000000, 'tx_index': 502}},
                {'table': 'credits', 'values': {'asset': 'XDP', 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'quantity': 100000000, 'address': '1_nUtoWndFgmzPquS2iJAFUPEtVhRX7jfobH_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'block_index': DP['default_block'], 'calling_function': 'send'}},
                {'table': 'debits', 'values': {'asset': 'XDP', 'action': 'send', 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'quantity': 100000000, 'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'block_index': DP['default_block']}}
            ]
        }, {
            'in': ({'block_index': DP['default_block'], 'block_time': 155409000, 'fee': 10000, 'tx_index': 502, 'tx_hash': '8fc698cf1fcd51e3d685511185c67c0a73e7b72954c6abbd29fbbbe560e043a0', 'btc_amount': 7800, 'data': b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x03:>\x7f\xff\xff\xff\xff\xff\xff\xff', 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'destination': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'supported': 1, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8'},),
            'records': [
                {'table': 'sends', 'values': {'block_index': DP['default_block'], 'destination': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'tx_hash': '8fc698cf1fcd51e3d685511185c67c0a73e7b72954c6abbd29fbbbe560e043a0', 'quantity': 9223372036854775807, 'asset': 'MAXI', 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'status': 'valid', 'tx_index': 502}},
                {'table': 'credits', 'values': {'block_index': DP['default_block'], 'asset': 'MAXI', 'quantity': 9223372036854775807, 'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'calling_function': 'send', 'event': '8fc698cf1fcd51e3d685511185c67c0a73e7b72954c6abbd29fbbbe560e043a0'}},
                {'table': 'debits', 'values': {'block_index': DP['default_block'], 'action': 'send', 'asset': 'MAXI', 'quantity': 9223372036854775807, 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'event': '8fc698cf1fcd51e3d685511185c67c0a73e7b72954c6abbd29fbbbe560e043a0'}}
            ]
        }]
    },
    'issuance': {
        'validate': [{
            ...
            'in': (ADDR[0], None, 'DOGE', 1000, True, False, None, None, '', DP['default_block']),
            'out': (0, 0.0, ['cannot issue DOGE or XDP'], 50000000, '', True, False)
        }, {
            'in': (ADDR[0], None, 'XDP', 1000, True, False, None, None, '', DP['default_block']),
            'out': (0, 0.0, ['cannot issue DOGE or XDP'], 50000000, '', True, False)
        }, {
        ...
        'compose': [{
            ...
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [], b'\x00\x00\x00\x14\x00\x00\x00\x00\x00\x0b\xfc\xe3\x00\x00\x00\x00\x00\x00\x03\xe8\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
        }, {
            'in': (ADDR[0], None, 'BSSET', 1000, True, 'description much much much longer than 42 letters'),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [], b'\x00\x00\x00\x14\x00\x00\x00\x00\x00\x0b\xfc\xe3\x00\x00\x00\x00\x00\x00\x03\xe8\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00description much much much longer than 42 letters')
        }, {
            'in': (ADDR[0], ADDR[1], 'DIVISIBLE', 0, True, ''),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', None)], b'\x00\x00\x00\x14\x00\x00\x00\xa2[\xe3Kf\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
        }, {
            'in': (MULTISIGADDR[0], None, 'BSSET', 1000, True, ''),
            'out': ('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', [], b'\x00\x00\x00\x14\x00\x00\x00\x00\x00\x0b\xfc\xe3\x00\x00\x00\x00\x00\x00\x03\xe8\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
        }, {
            'in': (ADDR[0], MULTISIGADDR[0], 'DIVISIBLE', 0, True, ''),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', None)], b'\x00\x00\x00\x14\x00\x00\x00\xa2[\xe3Kf\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
        }, {
            'in': (ADDR[0], None, 'MAXIMUM', 2**63-1, True, 'Maximum quantity'),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [], b'\x00\x00\x00\x14\x00\x00\x00\x00\xdd\x96\xd2t\x7f\xff\xff\xff\xff\xff\xff\xff\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10Maximum quantity')
        }, {
            'in': (ADDR[0], None, 'A{}'.format(2**64 - 1), 1000, None, None),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [], b'\x00\x00\x00\x14\xff\xff\xff\xff\xff\xff\xff\xff\x00\x00\x00\x00\x00\x00\x03\xe8\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
        }, {
        ...
        'parse': [{
            'in': ({'supported': 1, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'data': b'\x00\x00\x00\x14\x00\x00\x00\x00\x00\xbaOs\x00\x00\x00\x00\x00\x00\x03\xe8\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', 'btc_amount': None, 'destination': None, 'block_time': 155409000, 'block_index': DP['default_block'], 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'fee': 10000, 'tx_index': 502, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8'},),
            'records': [
                {'table': 'issuances', 'values': {'locked': 0, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'description': '', 'divisible': 1, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'asset': 'BASSET', 'issuer': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'status': 'valid', 'tx_index': 502, 'fee_paid': 50000000, 'block_index': DP['default_block'], 'transfer': 0, 'quantity': 1000}},
                {'table': 'credits', 'values': {'calling_function': 'issuance', 'block_index': DP['default_block'], 'asset': 'BASSET', 'quantity': 1000, 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d'}},
                {'table': 'debits', 'values': {'block_index': DP['default_block'], 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'asset': 'XDP', 'quantity': 50000000, 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'action': 'issuance fee'}}
            ]
        }, {
            'in': ({'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'block_time': 155409000, 'btc_amount': 7800, 'supported': 1, 'tx_index': 502, 'block_index': DP['default_block'], 'data': b'\x00\x00\x00\x14\x00\x00\x00\xa2[\xe3Kf\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'fee': 10000, 'destination': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65'},),
            'records': [
                {'table': 'issuances', 'values': {'locked': 0, 'block_index': DP['default_block'], 'description': '', 'quantity': 0, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'asset': 'DIVISIBLE', 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'fee_paid': 0, 'issuer': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'tx_index': 502, 'transfer': 1, 'divisible': 1, 'status': 'valid'}}
            ]
        }, {
            'in': ({'tx_index': 502, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'data': b'\x00\x00\x00\x14\x00\x00\x00\xa2[\xe3Kf\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x04LOCK', 'block_time': 155409000, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'fee': 10000, 'destination': None, 'supported': 1, 'block_index': DP['default_block'], 'btc_amount': None},),
            'records': [
                {'table': 'issuances', 'values': {'tx_index': 502, 'quantity': 0, 'block_index': DP['default_block'], 'status': 'valid', 'locked': 1, 'description': 'Divisible asset', 'divisible': 1, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'transfer': 0, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'issuer': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'fee_paid': 0, 'asset': 'DIVISIBLE'}}
            ]
        }, {
            'in': ({'data': b'\x00\x00\x00\x14\x00\x00\x00\x00\x00\x0b\xfc\xe3\x00\x00\x00\x00\x00\x00\x03\xe8\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', 'supported': 1, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'block_index': DP['default_block'], 'destination': '', 'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'btc_amount': 0, 'tx_index': 502, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'block_time': 155409000, 'fee': 10000},),
            'records': [
                {'table': 'issuances', 'values': {'issuer': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'asset': 'BSSET', 'description': '', 'block_index': DP['default_block'], 'transfer': 0, 'quantity': 1000, 'status': 'valid', 'divisible': 1, 'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'locked': 0, 'tx_index': 502, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'fee_paid': 50000000}},
                {'table': 'credits', 'values': {'quantity': 1000, 'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'asset': 'BSSET', 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'calling_function': 'issuance', 'block_index': DP['default_block']}},
                {'table': 'debits', 'values': {'quantity': 50000000, 'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'asset': 'XDP', 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'action': 'issuance fee', 'block_index': DP['default_block']}}
            ]
        }, {
            'in': ({'fee': 10000, 'block_time': 155409000, 'data': b'\x00\x00\x00\x14\x00\x00\x00\xa2[\xe3Kf\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', 'block_index': DP['default_block'], 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'btc_amount': 7800, 'tx_index': 502, 'destination': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'supported': 1, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'},),
            'records': [
                {'table': 'issuances', 'values': {'fee_paid': 0, 'divisible': 1, 'block_index': DP['default_block'], 'tx_index': 502, 'description': '', 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'transfer': 1, 'issuer': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'locked': 0, 'asset': 'DIVISIBLE', 'status': 'valid', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'quantity': 0}},
                {'table': 'debits', 'values': {'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'asset': 'XDP', 'action': 'issuance fee', 'block_index': DP['default_block'], 'quantity': 0}}
            ]
        }, {
            'in': ({'data': b'\x00\x00\x00\x14\x00\x00\x00\x00\xdd\x96\xd2t\x7f\xff\xff\xff\xff\xff\xff\xff\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10Maximum quantity', 'block_time': 155409000, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'block_index': DP['default_block'], 'btc_amount': 0, 'fee': 10000, 'supported': 1, 'tx_index': 502, 'destination': '', 'tx_hash': '71da4fac29d6442ef3ff13f291860f512a888161ae9e574f313562851912aace'},),
            'records': [
                {'table': 'issuances', 'values': {'issuer': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'transfer': 0, 'divisible': 1, 'description': 'Maximum quantity', 'asset': 'MAXIMUM', 'tx_index': 502, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'block_index': DP['default_block'], 'quantity': 9223372036854775807, 'status': 'valid', 'tx_hash': '71da4fac29d6442ef3ff13f291860f512a888161ae9e574f313562851912aace', 'fee_paid': 50000000, 'locked': 0}},
                {'table': 'credits', 'values': {'asset': 'MAXIMUM', 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'block_index': DP['default_block'], 'quantity': 9223372036854775807, 'event': '71da4fac29d6442ef3ff13f291860f512a888161ae9e574f313562851912aace', 'calling_function': 'issuance'}},
                {'table': 'debits', 'values': {'asset': 'XDP', 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'block_index': DP['default_block'], 'action': 'issuance fee', 'quantity': 50000000, 'event': '71da4fac29d6442ef3ff13f291860f512a888161ae9e574f313562851912aace'}}
            ]
        }, {
            ...
            'records': [
                {'table': 'issuances', 'values': {'transfer': 0, 'tx_hash': '4188c1f7aaae56ce3097ef256cdbcb644dd43c84e237b4add4f24fd4848cb2c7', 'divisible': 1, 'status': 'valid', 'asset': 'A18446744073709551615', 'description': '', 'tx_index': 502, 'issuer': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'fee_paid': 0, 'locked': 0, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'block_index': DP['default_block'], 'quantity': 1000}},
                {'table': 'credits', 'values': {'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'asset': 'A18446744073709551615', 'event': '4188c1f7aaae56ce3097ef256cdbcb644dd43c84e237b4add4f24fd4848cb2c7', 'block_index': DP['default_block'], 'quantity': 1000, 'calling_function': 'issuance'}},
                {'table': 'debits', 'values': {'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'action': 'issuance fee', 'asset': 'XDP', 'event': '4188c1f7aaae56ce3097ef256cdbcb644dd43c84e237b4add4f24fd4848cb2c7', 'block_index': DP['default_block'], 'quantity': 0}}
            ]
        }]
    },
    'dividend': {
        'validate': [{
            'in': (ADDR[0], DP['quantity'] * 1000, 'DIVISIBLE', 'XDP', DP['default_block']),
            'out': (1100000000000, [{'address_quantity': 100000000, 'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'dividend_quantity': 100000000000}, {'address_quantity': 1000000000, 'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'dividend_quantity': 1000000000000}], ['insufficient funds (XDP)'], 0)
        }, {
            'in': (ADDR[0], DP['quantity'] * -1000, 'DIVISIBLE', 'XDP', DP['default_block']),
            'out': (-1100000000000, [{'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'dividend_quantity': -100000000000, 'address_quantity': 100000000}, {'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'dividend_quantity': -1000000000000, 'address_quantity': 1000000000}], ['non‐positive quantity per unit'], 0)
        }, {
            'in': (ADDR[0], DP['quantity'], 'DOGE', 'XDP', DP['default_block']),
            'out': (None, None, ['cannot pay dividends to holders of DOGE', 'no such asset, DOGE.'], 0)
        }, {
            'in': (ADDR[0], DP['quantity'], 'XDP', 'XDP', DP['default_block']),
            'out': (None, None, ['cannot pay dividends to holders of XDP', 'no such asset, XDP.'], 0)
        }, {
            'in': (ADDR[0], DP['quantity'], 'NOASSET', 'XDP', DP['default_block']),
            'out': (None, None, ['no such asset, NOASSET.'], 0)
        }, {
            'in': (ADDR[0], 0, 'DIVISIBLE', 'XDP', DP['default_block']),
            'out': (0,  [{'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'dividend_quantity': 0, 'address_quantity': 100000000}, {'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'dividend_quantity': 0, 'address_quantity': 1000000000}], ['non‐positive quantity per unit', 'zero dividend'], 0)
        }, {
            'in': (ADDR[1], DP['quantity'], 'DIVISIBLE', 'XDP', DP['default_block']),
            'out': (99900000000, [{'dividend_quantity': 98900000000, 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'address_quantity': 98900000000}, {'dividend_quantity': 1000000000, 'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'address_quantity': 1000000000}], ['only issuer can pay dividends', 'insufficient funds (XDP)'], 0)
        }, {
            'in': (ADDR[0], DP['quantity'], 'DIVISIBLE', 'NOASSET', DP['default_block']),
            'out': (None, None, ['no such dividend asset, NOASSET.'], 0)
        }, {
            'in': (ADDR[0], 8359090909, 'DIVISIBLE', 'XDP', DP['default_block']),
            'out': (91949999999, [{'address_quantity': 100000000, 'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'dividend_quantity': 8359090909}, {'address_quantity': 1000000000, 'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'dividend_quantity': 83590909090}], ['insufficient funds (XDP)'], 40000)
        }, {
            'in': (ADDR[2], 100000000, 'DIVIDEND', 'DIVIDEND', DP['default_block']),
            'out': (10, [{'address_quantity': 10, 'address': 'nW8dXfYakP7aSyPuzEcAdFyrjFXimPkvct', 'dividend_quantity': 10}], ['insufficient funds (XDP)'], 20000)
        }],
        'compose': [{
            'in': (ADDR[0], DP['quantity'], 'DIVISIBLE', 'XDP'),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [], b'\x00\x00\x002\x00\x00\x00\x00\x05\xf5\xe1\x00\x00\x00\x00\xa2[\xe3Kf\x00\x00\x00\x00\x00\x00\x00\x01')
        }, {
            'in': (ADDR[0], 1, 'NODIVISIBLE', 'XDP'),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [], b'\x00\x00\x002\x00\x00\x00\x00\x00\x00\x00\x01\x00\x06\xca\xd8\xdc\x7f\x0bf\x00\x00\x00\x00\x00\x00\x00\x01')
        }],
        'parse': [{
            'in': ({'tx_hash': '450c4ced564fa52a84746ecd79d64db6f124bddee19ff2c3cd926adea673ce4c', 'supported': 1, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'data': b'\x00\x00\x002\x00\x00\x00\x00\x05\xf5\xe1\x00\x00\x00\x00\xa2[\xe3Kf\x00\x00\x00\x00\x00\x00\x00\x01', 'tx_index': 502, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'block_index': DP['default_block'], 'btc_amount': 0, 'fee': 10000, 'destination': '', 'block_time': 155409000},),
            'records': [
                {'table': 'dividends', 'values': {'tx_hash': '450c4ced564fa52a84746ecd79d64db6f124bddee19ff2c3cd926adea673ce4c', 'fee_paid': 40000, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'tx_index': 502, 'block_index': DP['default_block'], 'dividend_asset': 'XDP', 'status': 'valid', 'quantity_per_unit': 100000000, 'asset': 'DIVISIBLE'}},
                {'table': 'credits', 'values': {'calling_function': 'dividend', 'asset': 'XDP', 'block_index': DP['default_block'], 'quantity': 100000000, 'event': '450c4ced564fa52a84746ecd79d64db6f124bddee19ff2c3cd926adea673ce4c', 'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65'}},
                {'table': 'credits', 'values': {'calling_function': 'dividend', 'asset': 'XDP', 'block_index': DP['default_block'], 'quantity': 1000000000, 'event': '450c4ced564fa52a84746ecd79d64db6f124bddee19ff2c3cd926adea673ce4c', 'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2'}},
                {'table': 'debits', 'values': {'asset': 'XDP', 'action': 'dividend', 'block_index': DP['default_block'], 'quantity': 1100000000, 'event': '450c4ced564fa52a84746ecd79d64db6f124bddee19ff2c3cd926adea673ce4c', 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'}},
                {'table': 'debits', 'values': {'asset': 'XDP', 'action': 'dividend fee', 'block_index': DP['default_block'], 'quantity': 40000, 'event': '450c4ced564fa52a84746ecd79d64db6f124bddee19ff2c3cd926adea673ce4c', 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'}}
            ]
        }, {
            'in': ({'tx_index': 502, 'btc_amount': 0, 'block_time': 155409000, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'tx_hash': '5a36e9d939e70917695065b11b728f7ccbc7b828ae3baca1115885d8889e67c7', 'fee': 10000, 'block_index': DP['default_block'], 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'supported': 1, 'destination': '', 'data': b'\x00\x00\x002\x00\x00\x00\x00\x00\x00\x00\x01\x00\x06\xca\xd8\xdc\x7f\x0bf\x00\x00\x00\x00\x00\x00\x00\x01'},),
            'records': [
                {'table': 'dividends', 'values': {'tx_index': 502, 'asset': 'NODIVISIBLE', 'fee_paid': 40000, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'tx_hash': '5a36e9d939e70917695065b11b728f7ccbc7b828ae3baca1115885d8889e67c7', 'dividend_asset': 'XDP', 'block_index': DP['default_block'], 'quantity_per_unit': 1, 'status': 'valid'}},
                {'table': 'credits', 'values': {'asset': 'XDP', 'event': '5a36e9d939e70917695065b11b728f7ccbc7b828ae3baca1115885d8889e67c7', 'calling_function': 'dividend', 'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'quantity': 5, 'block_index': DP['default_block']}},
                {'table': 'credits', 'values': {'asset': 'XDP', 'event': '5a36e9d939e70917695065b11b728f7ccbc7b828ae3baca1115885d8889e67c7', 'calling_function': 'dividend', 'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'quantity': 10, 'block_index': DP['default_block']}},
                {'table': 'debits', 'values': {'asset': 'XDP', 'event': '5a36e9d939e70917695065b11b728f7ccbc7b828ae3baca1115885d8889e67c7', 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'quantity': 15, 'block_index': DP['default_block'], 'action': 'dividend'}},
                {'table': 'debits', 'values': {'asset': 'XDP', 'event': '5a36e9d939e70917695065b11b728f7ccbc7b828ae3baca1115885d8889e67c7', 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'quantity': 40000, 'block_index': DP['default_block'], 'action': 'dividend fee'}}
            ]
        }]
    },
    'order': {
        'validate': [{
            'in': (ADDR[0], 'DIVISIBLE', DP['quantity'], 'XDP', DP['quantity'], 2000, 0, DP['default_block']),
            'out': ([])
        }, {
            'in': (ADDR[0], 'DIVISIBLE', DP['quantity'], 'XDP', DP['quantity'], 2000, 0.5, DP['default_block']),
            'out': (['fee_required must be in satoshis'])
        }, {
            'in': (ADDR[0], 'DOGE', DP['quantity'], 'DOGE', DP['quantity'], 2000, 0, DP['default_block']),
            'out': (['cannot trade DOGE for itself'])
        },{
            'in': (ADDR[0], 'DIVISIBLE', DP['quantity'] / 3, 'XDP', DP['quantity'], 2000, 0, DP['default_block']),
            'out': (['give_quantity must be in satoshis'])
        },{
            'in': (ADDR[0], 'DIVISIBLE', DP['quantity'], 'XDP', DP['quantity'] / 3, 2000, 0, DP['default_block']),
            'out': (['get_quantity must be in satoshis'])
        },{
            'in': (ADDR[0], 'DIVISIBLE', DP['quantity'], 'XDP', DP['quantity'], 1.5, 0, DP['default_block']),
            'out': (['expiration must be expressed as an integer block delta'])
        },{
            'in': (ADDR[0], 'DIVISIBLE', -DP['quantity'], 'XDP', -DP['quantity'], -2000, -10000, DP['default_block']),
            'out': (['non‐positive give quantity', 'non‐positive get quantity', 'negative fee_required', 'negative expiration'])
        },{
            'in': (ADDR[0], 'DIVISIBLE', 0, 'XDP', DP['quantity'], 2000, 0, DP['default_block']),
            ...
            'in': (ADDR[0], 'DIVISIBLE', 2**63 + 10, 'XDP', DP['quantity'], 4 * 2016 + 10, 0, DP['default_block']),
            'out': (['expiration overflow', 'integer overflow'])
        }],
        'compose': [{
            'in': (ADDR[0], 'DOGE', DP['small'], 'XDP', DP['small'] * 2, DP['expiration'], 0),
            'out': ('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', [], b'\x00\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\xfa\xf0\x80\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x00')
        }, {
            'in': (ADDR[0], 'XDP', round(DP['small'] * 2.1), 'DOGE', DP['small'], DP['expiration'], DP['fee_required']),
            ...
            'in': (MULTISIGADDR[0], 'DOGE', DP['small'], 'XDP', DP['small'] * 2, DP['expiration'], 0),
            'out': ('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', [], b'\x00\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\xfa\xf0\x80\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x00')
        }, {
            'in': (MULTISIGADDR[0], 'XDP', round(DP['small'] * 2.1), 'DOGE', DP['small'], DP['expiration'], DP['fee_required']),
            'out': ('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', [], b'\x00\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x06B,@\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\xfa\xf0\x80\x00\n\x00\x00\x00\x00\x00\r\xbb\xa0')
        }, {
            'in': (ADDR[0], 'MAXI', 2**63 - 1, 'XDP', DP['quantity'], DP['expiration'], DP['fee_required']),
        ...
        'parse': [{
            'in': ({'destination': None, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'source': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'block_time': 155409000, 'block_index': DP['default_block'], 'tx_index': 502, 'data': b'\x00\x00\x00\n\x00\x00\x00\xa2[\xe3Kf\x00\x00\x00\x00\x05\xf5\xe1\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00\x07\xd0\x00\x00\x00\x00\x00\x00\x00\x00', 'fee': 10000, 'btc_amount': None, 'supported': 1, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8'},),
            'records': [
                {'table': 'orders', 'values': {'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'source': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'fee_required_remaining': 0, 'block_index': DP['default_block'], 'status': 'filled', 'get_quantity': 100000000, 'fee_provided_remaining': 10000, 'get_asset': 'XDP', 'give_remaining': 0, 'fee_provided': 10000, 'expiration': 2000, 'get_remaining': 0, 'tx_index': 502, 'give_asset': 'DIVISIBLE', 'expire_index': DP['default_block'] + 2000, 'give_quantity': 100000000, 'fee_required': 0}},
                {'table': 'order_matches', 'values': {'status': 'completed', 'tx0_index': 7, 'tx0_address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'forward_quantity': 100000000, 'tx1_address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'backward_asset': 'DIVISIBLE', 'tx0_hash': '074fa38a84a81c0ed7957484ebe73836104d3068f66b189e05a7cf0b95c737f3', 'tx0_expiration': 2000, 'id': '074fa38a84a81c0ed7957484ebe73836104d3068f66b189e05a7cf0b95c737f3_db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'tx1_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'tx1_expiration': 2000, 'tx1_block_index': DP['default_block'], 'forward_asset': 'XDP', 'fee_paid': 0, 'match_expire_index': DP['default_block'] + 20, 'tx0_block_index': DP['default_block'] - 495, 'backward_quantity': 100000000, 'tx1_index': 502, 'block_index': DP['default_block']}},
                {'table': 'credits', 'values': {'event': '074fa38a84a81c0ed7957484ebe73836104d3068f66b189e05a7cf0b95c737f3_db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'asset': 'XDP', 'block_index': DP['default_block'], 'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'quantity': 100000000, 'calling_function': 'order match'}},
                {'table': 'debits', 'values': {'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'block_index': DP['default_block'], 'quantity': 100000000, 'asset': 'DIVISIBLE', 'action': 'open order'}},
                {'table': 'credits', 'values': {'event': '074fa38a84a81c0ed7957484ebe73836104d3068f66b189e05a7cf0b95c737f3_db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'asset': 'DIVISIBLE', 'block_index': DP['default_block'], 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'quantity': 100000000, 'calling_function': 'order match'}},
                {'table': 'credits', 'values': {'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'asset': 'XDP', 'block_index': DP['default_block'], 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'quantity': 0, 'calling_function': 'filled'}},
                {'table': 'credits', 'values': {'event': '074fa38a84a81c0ed7957484ebe73836104d3068f66b189e05a7cf0b95c737f3', 'asset': 'DIVISIBLE', 'block_index': DP['default_block'], 'address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'quantity': 0, 'calling_function': 'filled'}}
            ]
        }, {
            ...
            'records': [
                {'table': 'orders', 'values': {'give_quantity': 1000000, 'status': 'open', 'get_remaining': 0, 'tx_index': 502, 'source': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'give_remaining': 0, 'block_index': DP['default_block'], 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'fee_required': 0, 'fee_provided': 10000, 'give_asset': 'DOGE', 'get_asset': 'XDP', 'fee_provided_remaining': 1000, 'expiration': 2000, 'expire_index': DP['default_block'] + 2000, 'fee_required_remaining': 0, 'get_quantity': 100000000}},
                {'table': 'order_matches', 'values': {'forward_asset': 'XDP', 'id': 'b6db5c8412a58d9fa75bff41f8a7519353ffd4d359c7c8fa7ee1900bc05e4d9d_db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'tx0_address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'tx1_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'forward_quantity': 100000000, 'match_expire_index': DP['default_block'] + 20, 'tx1_block_index': DP['default_block'], 'backward_quantity': 1000000, 'block_index': DP['default_block'], 'fee_paid': 9000, 'tx1_index': 502, 'tx1_expiration': 2000, 'tx0_hash': 'b6db5c8412a58d9fa75bff41f8a7519353ffd4d359c7c8fa7ee1900bc05e4d9d', 'tx1_address': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'tx0_index': 11, 'tx0_block_index': DP['default_block'] - 491, 'backward_asset': 'DOGE', 'tx0_expiration': 2000, 'status': 'pending'}}
            ]
        }, {
            ...
            'records': [
                {'table': 'orders', 'values': {'block_index': DP['default_block'], 'fee_required_remaining': 0, 'source': 'nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'give_remaining': 500000, 'expiration': 2000, 'give_quantity': 500000, 'get_asset': 'XDP', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'fee_provided_remaining': 1000000, 'tx_index': 502, 'fee_required': 0, 'give_asset': 'DOGE', 'expire_index': DP['default_block'] + 2000, 'get_remaining': 100000000, 'fee_provided': 1000000, 'get_quantity': 100000000, 'status': 'open'}}
            ]
        }, {
            ...
            'records': [
                {'table': 'orders', 'values': {'fee_required_remaining': 0, 'fee_provided_remaining': 10000, 'block_index': DP['default_block'], 'give_remaining': 500, 'status': 'open', 'fee_required': 0, 'fee_provided': 10000, 'expiration': 2000, 'give_quantity': 500, 'get_asset': 'XDP', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'tx_index': 502, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'get_remaining': 100000000, 'get_quantity': 100000000, 'give_asset': 'NODIVISIBLE', 'expire_index': DP['default_block'] + 2000}},
                {'table': 'debits', 'values': {'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'block_index': DP['default_block'], 'quantity': 500, 'action': 'open order', 'asset': 'NODIVISIBLE'}}
            ]
        }, {
            'in': ({'block_index': DP['default_block'], 'data': b'\x00\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\xfa\xf0\x80\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x00', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'destination': '', 'fee': 10000, 'tx_index': 502, 'supported': 1, 'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'block_time': 155409000, 'btc_amount': 0},),
            'records': [
                {'table': 'orders', 'values': {'block_index': DP['default_block'], 'expiration': 10, 'expire_index': DP['default_block'] + 10, 'fee_required_remaining': 0, 'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'fee_provided': 10000, 'status': 'open', 'give_asset': 'DOGE', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'get_remaining': 0, 'give_remaining': 49000000, 'tx_index': 502, 'get_asset': 'XDP', 'fee_provided_remaining': 1000, 'fee_required': 0, 'give_quantity': 50000000, 'get_quantity': 100000000}},
                {'table': 'order_matches', 'values': {'backward_quantity': 1000000, 'tx0_hash': 'b6db5c8412a58d9fa75bff41f8a7519353ffd4d359c7c8fa7ee1900bc05e4d9d', 'tx1_block_index': DP['default_block'], 'match_expire_index': DP['default_block'] + 20, 'tx0_address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'tx0_block_index': DP['default_block'] - 491, 'status': 'pending', 'block_index': DP['default_block'], 'tx1_address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'forward_quantity': 100000000, 'tx1_index': 502, 'fee_paid': 9000, 'id': 'b6db5c8412a58d9fa75bff41f8a7519353ffd4d359c7c8fa7ee1900bc05e4d9d_db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'forward_asset': 'XDP', 'tx0_expiration': 2000, 'tx1_expiration': 10, 'backward_asset': 'DOGE', 'tx0_index': 11, 'tx1_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d'}}
            ]
        }, {
            'in': ({'block_index': DP['default_block'], 'data': b'\x00\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\xfa\xf0\x80\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x00', 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'destination': '', 'fee': 10000, 'tx_index': 502, 'supported': 1, 'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'block_time': 155409000, 'btc_amount': 0},),
            'records': [
            ...
            'in': ({'fee': 10000, 'btc_amount': 0, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'tx_index': 502, 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'supported': 1, 'block_time': 155409000, 'block_index': DP['default_block'], 'data': b'\x00\x00\x00\n\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x06B,@\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02\xfa\xf0\x80\x00\n\x00\x00\x00\x00\x00\r\xbb\xa0', 'destination': ''},),
            'records': [
                {'table': 'orders', 'values': {'get_asset': 'DOGE', 'give_asset': 'XDP', 'fee_required': 900000, 'block_index': DP['default_block'], 'expire_index': DP['default_block'] + 10, 'give_remaining': 105000000, 'fee_provided_remaining': 10000, 'tx_hash': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'tx_index': 502, 'expiration': 10, 'status': 'open', 'source': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'give_quantity': 105000000, 'get_quantity': 50000000, 'fee_provided': 10000, 'fee_required_remaining': 900000, 'get_remaining': 50000000}},
                {'table': 'debits', 'values': {'event': 'db6d9052b576d973196363e11163d492f50926c2f1d1efd67b3d999817b0d04d', 'asset': 'XDP', 'quantity': 105000000, 'address': '1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 'block_index': DP['default_block'], 'action': 'open order'}}
            ]
        }, {
            'in': ({'btc_amount': 0, 'fee': 10000, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'destination': '', 'tx_hash': '0ec7da68a67e165693afd6c97566f8f509d302bceec8d1be0100335718a40fe5', 'tx_index': 502, 'data': b'\x00\x00\x00\n\x00\x00\x00\x00\x00\x03:>\x7f\xff\xff\xff\xff\xff\xff\xff\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00\x00\n\x00\x00\x00\x00\x00\r\xbb\xa0', 'block_hash': '2d62095b10a709084b1854b262de77cb9f4f7cd76ba569657df8803990ffbfc6c12bca3c18a44edae9498e1f0f054072e16eef32dfa5e3dd4be149009115b4b8', 'supported': 1, 'block_time': 155409000, 'block_index': DP['default_block']},),
            'records': [
                {'table': 'orders', 'values': {'fee_provided_remaining': 10000, 'source': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'block_index': DP['default_block'], 'tx_index': 502, 'fee_required': 900000, 'give_asset': 'MAXI', 'status': 'open', 'get_remaining': 100000000, 'give_quantity': 9223372036854775807, 'give_remaining': 9223372036854775807, 'expiration': 10, 'get_asset': 'XDP', 'tx_hash': '0ec7da68a67e165693afd6c97566f8f509d302bceec8d1be0100335718a40fe5', 'expire_index': DP['default_block'] + 10, 'fee_provided': 10000, 'get_quantity': 100000000, 'fee_required_remaining': 900000}},
                {'table': 'debits', 'values': {'quantity': 9223372036854775807, 'asset': 'MAXI', 'action': 'open order', 'address': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', 'event': '0ec7da68a67e165693afd6c97566f8f509d302bceec8d1be0100335718a40fe5', 'block_index': DP['default_block']}}
            ]
        }],
        'expire': [{
            'in': (310500,),
    ...
    'transaction': {
        ...
        'construct': [{
            ...
            'in': (('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', [('ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH', 62000000)], None), {'encoding': 'multisig', 'fee_provided': 1.0}),
            'error': (exceptions.TransactionError, 'Fee provided must be in satoshis.')
        }, {
            'in': (('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', [('ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH', 5429)], None), {'encoding': 'singlesig'}),
            'error': (exceptions.TransactionError, 'Destination output is dust.')
        }, {
            'in': (('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', [('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', 7799)], None), {'encoding': 'multisig'}),
            'error': (exceptions.TransactionError, 'Destination output is dust.')
        }, {
            'in': (('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', [('ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH', 62000000)], b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x02\xfa\xf0\x80'), {'encoding': 'foobar'}),
            'error': (exceptions.TransactionError, 'Unknown encoding‐scheme.')
        }, {
            'in': (('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', [('ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH', 62000000)], b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x02\xfa\xf0\x80\x02\xfa\xf0\x80\x02\xfa\xf0\x80\x02\xfa\xf0\x80\x02\xfa\xf0\x80\x02\xfa\xf0\x80\x02\xfa\xf0\x80\x02\xfa\xf0'), {'encoding': 'opreturn'}),
            'error': (exceptions.TransactionError, 'One `OP_RETURN` output per transaction.')
        }, {
            'in': (('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', [('ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH', 2**30)], b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x02\xfa\xf0\x80'), {'encoding': 'multisig'}),
            'error': (exceptions.BalanceError,  'Insufficient DOGE at address nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65. (Need approximately 10.73759624 DOGE.) To spend unconfirmed coins, use the flag `--unconfirmed`. (Unconfirmed coins cannot be spent from multi‐sig addresses.)')
        }, {
            'comment': 'burn',
            'in': (('nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', [('ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH', 62000000)], None), {'encoding': 'multisig'}),
            ...
            'in': (('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', [('ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH', 50000000)], None), {'encoding': 'multisig'}),
            ...
            'in': (('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', [('niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F', None)], b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00'), {'encoding': 'multisig'}),
            ...
            'in': (('1_niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', [('1_nUtoWndFgmzPquS2iJAFUPEtVhRX7jfobH_nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65_2', None)], b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x05\xf5\xe1\x00'), {'encoding': 'multisig'}),
            'out': ''
        }, {
            ...
            'out': ''
        }, {
            'comment': 'multisig order',
    ...
    'script': {
        ...
        'scriptpubkey_to_address': [{
            'in': (['nUtoWndFgmzPquS2iJAFUPEtVhRX7jfobH', 'nUtoWndFgmzPquS2iJAFUPEtVhRX7jfobH'],),
            'out': None
        }],
        'get_asm': [{
            'in': ([],),
        ...
        'make_canonical': [{
            ...
            'out': 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'
        }, {
        ...
        'test_array': [{
            'in': ('1', ['nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'], 2),
            'out': None
        }, {
            'in': ('Q', ['nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'], 2),
            'error': (script.MultiSigAddressError, 'Signature values not integers.')
        }, {
            'in': ('1', ['nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'], None),
            'error': (script.MultiSigAddressError, 'Signature values not integers.')
        }, {
            'in': ('0', ['nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'], 2),
            'error': (script.MultiSigAddressError, 'Invalid signatures_required.')
        }, {
            'in': ('4', ['nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'], 2),
            'error': (script.MultiSigAddressError, 'Invalid signatures_required.')
        }, {
            'in': ('1', ['nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'], 1),
            'error': (script.MultiSigAddressError, 'Invalid signatures_possible.')
        }, {
            'in': ('2', ['nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'], 4),
            'error': (script.MultiSigAddressError, 'Invalid signatures_possible.')
        }, {
            'in': ('1', ['nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F_2'], 2),
            'error': (script.MultiSigAddressError, 'Invalid characters in pubkeys/pubkeyhashes.')
        },  {
            'in': ('3', ['nhKbsrhki5U9WUKyCwqqhqZN5CwzWmXk65', 'niVVidMwAXNtBsh8cPVXPssaHp1PKtZR6F'], 3),
    ...
    'util': {
        'api': [{
            ...
            'in': ('create_send', {'source': MULTISIGADDR[0], 'destination': MULTISIGADDR[1], 'asset': 'XDP', 'quantity': DP['quantity'], 'encoding': 'multisig'}),
            'out': ''
        }, {
            ...
            'in': ('create_order', {'source': MULTISIGADDR[0], 'give_asset': 'DOGE', 'give_quantity': DP['small'], 'get_asset': 'XDP', 'get_quantity': DP['small'] * 2, 'expiration': DP['expiration'], 'fee_required': 0, 'fee_provided': DP['fee_provided'], 'encoding': 'multisig'}),
            'out': ''
        }, {
            'in': ('create_order', {'source': MULTISIGADDR[0], 'give_asset': 'XDP', 'give_quantity': round(DP['small'] * 2.1), 'get_asset': 'DOGE', 'get_quantity': DP['small'], 'expiration': DP['expiration'], 'fee_required': DP['fee_required'], 'encoding': 'multisig'}),
            'out': ''
        }, {
        ...
        'debit': [{
            ...
            'in': (ADDR[0], 'DOGE', DP['quantity']),
            'error': (DebitError, 'Cannot debit bitcoins.')
        },  {
            'in': (ADDR[0], 'DOGE', -1 * DP['quantity']),
            'error': (DebitError, 'Negative quantity.')
        },  {
            'in': (ADDR[0], 'DOGE', 1.1 * DP['quantity']),
        ...
        'creations': [{
            'in': (),
            'out': {'CALLABLE': 1000, 'DIVIDEND': 100, 'DIVISIBLE': 100000000000, 'LOCKED': 1000, 'MAXI': 9223372036854775807, 'NODIVISIBLE': 1000, 'XDP': 185995878046}
        }],
        'destructions': [{
            'in': (),
            'out': {'XDP': 300000000}
        ...
        'supplies': [{
            'in': (),
            'out':  {'CALLABLE': 1000, 'DIVIDEND': 100, 'DIVISIBLE': 100000000000, 'LOCKED': 1000, 'MAXI': 9223372036854775807, 'NODIVISIBLE': 1000, 'XDP': 185695878046}
        }],
        'get_balance': [{
            'in': (ADDR[0], 'XDP'),
            'out': 91950000000
